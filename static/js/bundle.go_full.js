...
/***/ function(module, exports) {
	...
	var BoardIntersection = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement("div", { onClick: this.handleClick, className: this.state.classing, style: this.state.styling });
	    }
	});
	...
	var BoardView = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "div",
	            { style: this.state.styling, id: "board" },
	            this.props.board.intersections
	        );
	    }
	});
