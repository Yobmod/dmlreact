...
var patternomaly = __webpack_require__(16);

var charttt = __webpack_require__(17);
...
$.ajax({
	...
	success: function success(data) {
		//takes data from the url specified in var endpoint
		...
		options: {
			...
			annotation: {
				annotations: [{
					...
					onClick: function onClick(e) {// Fires when the user clicks this annotation on the chart (be sure to enable the event in the events array below).
					}
				}]
			}
		}
